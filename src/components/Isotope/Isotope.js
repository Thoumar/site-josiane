  ...
  return (
    <div className="Isotope" scroll-ref={scrollRef}>
      <ul className="Isotope__Menu">
        ...
        <li
          className={filterKey === "campagnes" ? "active" : ""}
          onClick={handleFilterKeyChange("campagnes")}
        >
          Les campagnes
        </li>
        <li
          className={filterKey === "causes" ? "active" : ""}
          onClick={handleFilterKeyChange("causes")}
        >
          Les grandes causes
        </li>
        <li
          className={filterKey === "activations" ? "active" : ""}
          onClick={handleFilterKeyChange("activations")}
        >
          Les activations
        </li>
      </ul>
        ...
        {projects.map((project, i) => {
          return (
            <div
              key={i}
              className={
                "Isotope__Item" + (project.filters ? " " + project.filters : "")
              }
              onClick={() => {
